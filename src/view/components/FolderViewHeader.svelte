...
<header>
    <div class="bm-header__search">
        <input placeholder="Search ..." type="text" bind:value={searchParam} />
    </div>

    <div class="bm-header__selection-buttons">
        <button
            class="bulk-tasks-button"
            onclick={() => selectAll(directory, true)}>Select All</button
        >
        <button
            class="bulk-tasks-button"
            onclick={() => selectAll(directory, false)}>De-Select All</button
        >
    </div>
</header>
